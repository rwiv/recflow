...
@Module({
  imports: [ConfigModule, ClientModule, ServiceModule, WebhookModule, PlatformModule],
  providers: [TrackedObserver, LiveAllocator, ChzzkLiveFilter, SoopLiveFilter, Dispatcher],
  exports: [TrackedObserver, LiveAllocator, ChzzkLiveFilter, SoopLiveFilter, Dispatcher],
})
