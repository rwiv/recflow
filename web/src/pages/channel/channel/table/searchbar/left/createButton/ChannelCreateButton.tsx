...
import { fetchPlatforms } from '@entities/platform/api/platform.client';
import { DialogButton } from '@shared/ui/dialog/DialogButton';
import { nonempty, uuid } from '@shared/lib/schema/schema_common';
import { PlatformDto } from '@entities/platform/api/platform.schema';
import { GradeDto } from '@entities/channel/grade/api/grade.schema';
import { useChannelPageStore } from '@entities/channel/channel/model/useChannelPageStore';
import { ChannelAppend } from '@entities/channel/channel/api/channel.types';
import { SelectFormField } from '@shared/ui/form/SelectFormField';
import { uppercase } from '@shared/lib/types/strings';
import { TextFormField } from '@shared/ui/form/TextFormField';
