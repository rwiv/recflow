...
import { TagAttachment, TagCreation, TagDetachment, TagRecord, TagUpdate } from './tag.types.js';

@Injectable()
export class TagRepository {
  private async create(req: TagCreation, tx: Tx = db): Promise<TagRecord> {
  ...
  async findAll(tx: Tx = db): Promise<TagRecord[]> {
